<div class="Shadow_Controls Grid_Container">
	<div class="Arrow Up_Arrow Row Justify_Content_Center" v-on:click="shift_up(index)">
		<div class="Icon_Container"><?php include "../assets/01_Icons/pan-controls/arrow-up.svg"; ?></div>
	</div>
	<div class="Arrow Left_Arrow Justify_Content_Center Column" v-on:click="shift_left(index)">
	...
	<div class="Arrow Right_Arrow Justify_Content_Center Column" v-on:click="shift_right(index)">
	...
	<div class="Arrow Down_Arrow Justify_Content_Center Row" v-on:click="shift_down(index)"><div class="Icon_Container"><?php include "../assets/01_Icons/pan-controls/arrow-down.svg"; ?>
	</div></div>
		<div class="Arrow Remove Justify_Content_Center Column" v-on:click="deleteShadow(index)">
