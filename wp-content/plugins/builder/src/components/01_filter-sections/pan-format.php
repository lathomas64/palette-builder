<div class="Pan_Format Filter_Section Column Gap_24">
...
<div class="Pan_Size Button_Group">
	<ul class="Row Gap_16">
		<li>
			<input onclick='Toggle_Filter(event, "finishes");' class="Single_Pan_Card"id="26mm" type="checkbox"/>
		...
		<li>
			<input onclick='Toggle_Filter(event, "finishes");' class="Single_Pan_Card"id="irregular" type="checkbox" />
			<label class="Single_Pan_Card" for="irregular"><div class="Card_Container Column Gap_8">
				...
				<div class="Shadow_Image_Container Column Justify_Content_Center Align_Items_Center Pan_Size_26 Pan_Shape_Irregular">
					<div class="Wrapper">
						<img src="/wp-content/plugins/builder/assets/irregular.svg"/>
						<div class="Pan_Shadow"></div>
					</div>
				</div>
			</div>
...
<div class="Pan_Size Button_Group">
	<ul class="Row Gap_16">
		<li>
			<input onclick='Toggle_Filter(event, "finishes");' class="Single_Pan_Card"id="Round" type="checkbox"/>
			<label class="Single_Pan_Card" for="Round"><div class="Card_Container Column Gap_8">
				...
				<div class="Shadow_Image_Container Column Justify_Content_Center Align_Items_Center Pan_Size_37 Pan_Shape_Round">
					<div class="Wrapper">
						<img src="/wp-content/plugins/builder/assets/circle.svg" />
						<div class="Pan_Shadow"></div>
					</div>
				</div>
			</div>
		...
		<li>
			<input onclick='Toggle_Filter(event, "finishes");' class="Single_Pan_Card"id="Other" type="checkbox" />
