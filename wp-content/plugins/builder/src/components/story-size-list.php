	<div class="Results Column Gap_24">
		...
		<div class="Story_Size Grid Row Gap_16">
			<a class="Search_Grid_Card Column Justify_Contents_Center Story_Size_3w_3t" href="#">
				<div class="Card_Container Column Gap_8">
					<div class="Card_Title">9 Pans</div>
						<div class="Card_Image_Container Column Align_Items_Center Justify_Content_Center">
							<div class="Wrapper">
							</div>
						</div>
				</div>
			</a>
			<a class="Search_Grid_Card Column Justify_Contents_Center" href="#">
				<div class="Card_Container Column Gap_8">
					<div class="Card_Title">9 Pans</div>
						<div class="Card_Image_Container Column Align_Items_Center Justify_Content_Center">
							<div class="Wrapper">
