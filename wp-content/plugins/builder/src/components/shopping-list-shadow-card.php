<div class="List_Tile Grid_Container">
	<div class="Shadow_Details Grid_Container Gap_16 Align_Items_Flex_End">
		<div class="Shadow Grid_Container Gap_16 Align_Content_Center">
	  <div class="Shadow_Image_Container Column Align_Items_Center Justify_Content_Center Pan_Size_26 Pan_Shape_Round">
		<div class="Wrapper">
			<img src="http://pb.rainbowcapitalism.com/wp-content/uploads/2021/10/Arcana.jpg">
			<div class="Pan_Shadow"></div>
		</div>
	</div>
	 <div class="Column Justify_Content_Flex_End">
	  <div class="Column Gap_4">
	   <div class="Row Gap_8">
	 ...
	 <div class="Price_Widget Reverse Column Gap_2" style="text-align: right;">
